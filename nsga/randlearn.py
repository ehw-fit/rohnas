# Generates random NN and try to learn it for a given number of epochs
import os
...
from main import random_configuration, evaluate_population, load_mnist, load_fmnist, load_cifar10, load_cifar100, load_svhn, set_args, set_data

def run_random(metrics, inshape):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_params', default=40000000, type=int)
    ...
    rets = run_random(metrics=["accuracy_drop", "energy", "memory", "latency"], inshape=inshape)
